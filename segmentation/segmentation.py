...
texture_method=1	# Flag to decide RGB or texture method
#----------------------------------------------------------------------------------------------#
#Filenames
if texture_method!=1:
	filename1='pic1.jpg'
	filename2='pic1_segmented_rgb.jpg'
	filename3='pic1_blue_segmented.jpg'
	filename4='pic1_green_segmented.jpg'
	filename5='pic1_red_segmented.jpg'
	filename7='pic1_segmented_rgb_contour.jpg'
	filename8='pic1_segmented_rgb_with_border.jpg'
			...
			if any(segmented_image[loopVar1][loopVar2])==True:	# For each non-zero pixel value
				try:
					...
					if (any(segmented_image[loopVar1-1][loopVar2])==False or any(segmented_image[loopVar1+1][loopVar2])==False or any(segmented_image[loopVar1][loopVar2-1])==False or any(segmented_image[loopVar1][loopVar2+1])==False):
						...
						image_with_border[loopVar1, loopVar2]=[0,0,0] # Mark the border with zero value in original image. This will eliminate small-noisy regions
